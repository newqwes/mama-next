        ...
        <>
            <section class="policy">
                <div class="wrapper policy__wrapper">
                    <h1>Политика конфиденциальности сайта "Мама дома".</h1>
                    <h2>Политика в отношении обработки персональных данных</h2>
                    <h3>1. Общие положения</h3>
                    <p>
                        Настоящая политика обработки персональных данных составлена в соответствии с требованиями закона Республики Беларусь
                        "Об информации, информатизации и защите информации Статья 32. Защита персональных данных." и определяет порядок
                        обработки персональных данных и меры по обеспечению безопасности персональных данных, предпринимаемые Мама дома
                        (далее – Оператор).
                    </p>
                    <div class="policy-padding">
                        ...
                        <p>
                            ...
                            всей информации, которую Оператор может получить о посетителях веб-сайта https://mama-doma.by/.
                        </p>
                    </div>
                    ...
                    <div class="policy-padding">
                        ...
                        <p>
                            ...
                            обеспечивающих их доступность в сети интернет по сетевому адресу https://mama-doma.by/;
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            Пользователю веб-сайта https://mama-doma.by/;
                        </p>
                        <p>2.9. Пользователь – любой посетитель веб-сайта https://mama-doma.by/;</p>
                        <p>
                    ...
                    <div class="policy-padding">
                        ...
                        <p>3.3. Сведения об образовании, профессии, специальности и квалификации, реквизиты документов об образовании;</p>
                        <p>3.4. Возраст;</p>
                        <p>
                    ...
                    <div class="policy-padding">
                        ...
                        <p>
                            ...
                            направив Оператору письмо на адрес электронной почты hr@mama-doma.by с пометкой «Отказ от уведомлений о новых
                    ...
                    <div class="policy-padding">
                        <p>
                            ...
                            Пользователем самостоятельно через специальные формы, расположенные на сайте https://mama-doma.by/. Заполняя
                    ...
                    <div class="policy-padding">
                        ...
                        <p>
                            ...
                            путем направления Оператору уведомление на адрес электронной почты Оператора hr@mama-doma.by с пометкой
                        ...
                        <p>
                            ...
                            электронный адрес Оператора hr@mama-doma.by с пометкой «Отзыв согласия на обработку персональных данных».
                        </p>
                    </div>
                    ...
                    <div class="policy-padding">
                        <p>
                            ...
                            персональных данных, обратившись к Оператору с помощью электронной почты hr@mama-doma.by.
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            https://mama-doma.by/policy.html.
                        </p>
                    </div>
                </div>
            </section>
