      ...
      <section class='policy'>
        <div class='wrapper policy__wrapper'>
          ...
          <p>
            ...
            требованиями закона Республики Беларусь "Об информации, информатизации и защите
            информации Статья 32. Защита персональных данных." и определяет порядок обработки
            персональных данных и меры по обеспечению безопасности персональных данных,
            предпринимаемые Мама дома (далее – Оператор).
          </p>
          <div class='policy-padding'>
            ...
            <p>
              ...
              посетителях веб-сайта https://mama-doma.by/.
            </p>
          </div>
          ...
          <div class='policy-padding'>
            ...
            <p>
              ...
              определенному или определяемому Пользователю веб-сайта https://mama-doma.by/;
            </p>
          ...
          <div class='policy-padding'>
            ...
            <p>
              3.3. Сведения об образовании, профессии, специальности и квалификации, реквизиты
          ...
          <div class='policy-padding'>
            ...
            <p>
              ...
              электронной почты hr@mama-doma.by с пометкой «Отказ от уведомлений о новых продуктах и
          ...
          <div class='policy-padding'>
            <p>
              ...
              расположенные на сайте https://mama-doma.by/. Заполняя соответствующие формы и/или
          ...
          <div class='policy-padding'>
            ...
            <p>
              ...
              электронной почты Оператора hr@mama-doma.by с пометкой «Актуализация персональных
              данных».
            </p>
            <p>
              ...
              hr@mama-doma.by с пометкой «Отзыв согласия на обработку персональных данных».
            </p>
          </div>
          ...
          <div class='policy-padding'>
            <p>
              ...
              электронной почты hr@mama-doma.by.
            </p>
            <p>
            ...
            <p>
              ...
              адресу https://mama-doma.by/policy.html.
            </p>
          </div>
        </div>
      </section>
